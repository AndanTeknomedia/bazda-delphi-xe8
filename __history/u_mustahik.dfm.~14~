object FMustahik: TFMustahik
  Left = 0
  Top = 0
  Caption = 'Data Mustahik'
  ClientHeight = 483
  ClientWidth = 795
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label6: TLabel
      ...
      Width = 250
      Height = 13
      Caption = '* Hanya mustahik yang menerima langsung dari BAZ'
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object MustahikBaru1: TMenuItem
      Action = acAdd
    end
  end
  ...
  object qFetch: TUniQuery
    ...
    SQL.Strings = (
      'select * from '
      #9'get_data_mustahik(:cab, :t1, :t2, :kec, :kel)')
    Left = 652
    Top = 276
    ParamData = <
      item
    ...
    object qFetchdata_penyaluran: TMemoField
      FieldName = 'data_penyaluran'
      ReadOnly = True
      BlobType = ftMemo
    end
  end
